...
const strings = new LocalizedStrings({
  fr: {
    ...
    CAR_AVAILABLE_TOOLTIP: 'Ce véhicule est disponible et répertorié dans les résultats de recherche.',
    CAR_UNAVAILABLE: 'Indisponible à la location',
    CAR_UNAVAILABLE_TOOLTIP: "Ce véhicule n'est pas disponible actuellement pour la location.",
  ...
  en: {
    ...
    CAR_AVAILABLE_TOOLTIP: 'This car is available and listed in search results.',
    CAR_UNAVAILABLE: 'Unavailable for rental',
    CAR_UNAVAILABLE_TOOLTIP: 'This car is currently unavailable for rental.',
  ...
  es: {
    ...
    CAR_AVAILABLE_TOOLTIP: 'Este coche está disponible e incluido en los resultados de búsqueda.',
    CAR_UNAVAILABLE: 'No disponible para alquiler',
    CAR_UNAVAILABLE_TOOLTIP: 'Este coche no está disponible actualmente para alquiler.',
