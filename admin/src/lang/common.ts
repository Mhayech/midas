...
const strings = new LocalizedStrings({
  fr: {
    ...
    UNAUTHORIZED_ERROR: 'Non autorisé. Veuillez vous reconnecter.',
    ...
    BOOKING_STATUS_PENDING_APPROVAL: 'En attente d\'approbation',
    FROM: 'Début',
    TO: 'Fin',
    ...
    RECORD_TYPE_ACCOUNTANT: 'Comptable',
    RECORD_TYPE_AGENCY_STAFF: 'Personnel',
    TYPE: 'Type',
    CONFIRM: 'Confirmer',
    USER: 'Utilisateur',
    INFO: 'Information',
    ...
    DRIVER_LICENSE_NUMBER: 'Numéro du permis de conduire',
    ...
    CREATED_BY: 'Créé par',
    REQUIRES_APPROVAL: 'Requiert l\'approbation de l\'admin',
    BOOKING_SENT_FOR_APPROVAL: 'Réservation envoyée pour approbation admin',
    BOOKING_CREATED: 'Réservation créée avec succès',
    DRIVER: 'Conducteur',
    PRICE: 'Prix',
    BOOKING: 'Réservation',
    APPROVAL_HISTORY: 'Historique d\'approbation',
    FLEET_TRACKING: 'Suivi de la flotte',
    GPS_TRACKING: 'Suivi GPS',
    LIVE_VEHICLE_TRACKING: 'Suivi des véhicules en temps réel',
    ONLINE: 'En ligne',
    OFFLINE: 'Hors ligne',
    SPEED: 'Vitesse',
    LAST_UPDATE: 'Dernière mise à jour',
    NO_GPS_DATA: 'Aucune donnée GPS disponible',
  ...
  en: {
    ...
    UNAUTHORIZED_ERROR: 'Unauthorized. Please sign in again.',
    ...
    BOOKING_STATUS_PENDING_APPROVAL: 'Pending Approval',
    FROM: 'From',
    TO: 'To',
    ...
    RECORD_TYPE_ACCOUNTANT: 'Accountant',
    RECORD_TYPE_AGENCY_STAFF: 'Staff',
    TYPE: 'Type',
    CONFIRM: 'Confirm',
    USER: 'User',
    INFO: 'Information',
    ...
    DRIVER_LICENSE_ISSUE_DATE: 'License Issue Date',
    ...
    BOOKING_SENT_FOR_APPROVAL: 'Booking sent for admin approval',
    ...
    LIVE_VEHICLE_TRACKING: 'Live Vehicle Tracking',
    ONLINE: 'Online',
    OFFLINE: 'Offline',
    SPEED: 'Speed',
  ...
  es: {
    ...
    BOOKING_STATUS_PENDING_APPROVAL: 'Pendiente de aprobación',
    FROM: 'Desde',
    TO: 'Hasta',
    ...
    CIN_NUMBER: 'Número CIN',
    DRIVER_LICENSE_NUMBER: 'Número de licencia de conducir',
    DRIVER_LICENSE_ISSUE_DATE: 'Fecha de emisión de la licencia',
    ...
    REQUIRES_APPROVAL: 'Requiere aprobación del administrador',
    BOOKING_SENT_FOR_APPROVAL: 'Reserva enviada para aprobación del administrador',
    BOOKING_CREATED: 'Reserva creada exitosamente',
    DRIVER: 'Conductor',
    PRICE: 'Precio',
    BOOKING: 'Reserva',
    APPROVAL_HISTORY: 'Historial de aprobación',
    RECORD_TYPE_ACCOUNTANT: 'Contable',
    RECORD_TYPE_AGENCY_STAFF: 'Personal',
    FLEET_TRACKING: 'Seguimiento de flota',
    GPS_TRACKING: 'Seguimiento GPS',
    LIVE_VEHICLE_TRACKING: 'Seguimiento de vehículos en tiempo real',
    ONLINE: 'En línea',
    OFFLINE: 'Fuera de línea',
    SPEED: 'Velocidad',
    LAST_UPDATE: 'Última actualización',
    NO_GPS_DATA: 'No hay datos GPS disponibles',
