...
export const es = {
  ...
  BOOKING_APPROVED_SUBJECT: 'Reserva aprobada',
  BOOKING_APPROVED_MESSAGE: 'Su reserva {{bookingId}} ha sido aprobada.',
  BOOKING_REJECTED_SUBJECT: 'Reserva rechazada',
  BOOKING_REJECTED_MESSAGE: 'Su reserva {{bookingId}} ha sido rechazada.',
  ADMIN_NOTES: 'Notas del administrador',
  MFA_OTP_SUBJECT: 'Su Código de Verificación',
  MFA_OTP_TITLE: 'Autenticación de Dos Factores',
  MFA_OTP_MESSAGE: 'Está intentando iniciar sesión en su cuenta. Por razones de seguridad, utilice el código de verificación a continuación para completar su inicio de sesión:',
  MFA_OTP_CODE_LABEL: 'Su Código de Verificación',
  MFA_OTP_EXPIRY: 'Este código expirará en 5 minutos.',
  MFA_OTP_SECURITY_NOTE: 'Si no solicitó este código, ignore este correo electrónico y asegúrese de que su cuenta esté segura.',
  MFA_OTP_RESEND_SUBJECT: 'Su Nuevo Código de Verificación',
  MFA_OTP_RESEND_TITLE: 'Nuevo Código de Verificación',
  MFA_OTP_RESEND_MESSAGE: 'Solicitó un nuevo código de verificación. Utilice el código a continuación para completar su inicio de sesión:',
}
