...
export const fr = {
  ...
  BOOKING_APPROVED_SUBJECT: 'Réservation approuvée',
  BOOKING_APPROVED_MESSAGE: 'Votre réservation {{bookingId}} a été approuvée.',
  BOOKING_REJECTED_SUBJECT: 'Réservation rejetée',
  BOOKING_REJECTED_MESSAGE: 'Votre réservation {{bookingId}} a été rejetée.',
  ADMIN_NOTES: "Notes de l'administrateur",
  MFA_OTP_SUBJECT: 'Votre Code de Vérification',
  MFA_OTP_TITLE: 'Authentification à Deux Facteurs',
  MFA_OTP_MESSAGE: 'Vous tentez de vous connecter à votre compte. Pour des raisons de sécurité, veuillez utiliser le code de vérification ci-dessous pour finaliser votre connexion :',
  MFA_OTP_CODE_LABEL: 'Votre Code de Vérification',
  MFA_OTP_EXPIRY: 'Ce code expirera dans 5 minutes.',
  MFA_OTP_SECURITY_NOTE: "Si vous n'avez pas demandé ce code, veuillez ignorer cet e-mail et assurez-vous que votre compte est sécurisé.",
  MFA_OTP_RESEND_SUBJECT: 'Votre Nouveau Code de Vérification',
  MFA_OTP_RESEND_TITLE: 'Nouveau Code de Vérification',
  MFA_OTP_RESEND_MESSAGE: 'Vous avez demandé un nouveau code de vérification. Veuillez utiliser le code ci-dessous pour finaliser votre connexion :',
}
